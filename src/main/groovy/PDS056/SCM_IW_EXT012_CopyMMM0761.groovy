 ...
 *
 * Name: SCM_IW_EXT012_CopyMMM0761
 * Description: Replicate MMM076 from PDS056
 * Date			Changed By			Description
 * 20210803		Franco Cortez		Replicate MMM076 from PDS056
 * 20210811		Franco Cortez		CR - Added OPTY (Color) column) and write records with all sizes-colors combinations.
 */
public class SCM_IW_EXT012_CopyMMM0761 extends ExtendM3Trigger {
  ...
  public SCM_IW_EXT012_CopyMMM0761(LoggerAPI logger, ProgramAPI program, DatabaseAPI database) {
    this.logger = logger;
  ...
  public void main() {
    ...
    String ZZSTYN = program.LDAZZ.TDA2;
